...
const SettingsManager = {
    ...
    async updateSystemSettings(settings) {
        try {
            // Update duplicate prevention config
            if (window.DuplicatePrevention) {
                window.DuplicatePrevention.config = {
                    strictMode: settings.strictMode,
                    caseSensitive: settings.caseSensitive,
                    trimWhitespace: true,
                    normalizeUrls: settings.autoNormalizeUrls,
                    similarityThreshold: settings.similarityThreshold
                };
            }

            // Update description auto-filler config
            if (window.DescriptionAutoFiller) {
                window.DescriptionAutoFiller.config = {
                    autoGenerate: settings.autoGenerateDescriptions,
                    overwriteUserChanges: settings.overwriteUserChanges,
                    defaultTemplate: settings.defaultTemplate,
                    minLength: settings.descriptionMinLength
                };
            }
